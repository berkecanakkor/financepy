...
def download_data(op, star_date, end_date):
    df = yf.download(op, start=star_date, end=end_date, progress=False)
    return df
...
def model_engine(model,num):
    ...
    print(f'Predicted with the accurary of : {r2_score(y_test,preds)}')
